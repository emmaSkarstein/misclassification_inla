...
In this file, we look at two simulated examples and a simultation study where the second example is simulated a number of times to examine the variability. 
